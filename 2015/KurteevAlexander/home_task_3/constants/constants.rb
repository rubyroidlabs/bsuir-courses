...
EXTRALS = 5
LECTOR_SEARCH_FORM = %r{[а..яА..Я]}
LECTOR_SEARCH_FORM_BH = %r{/node/|/lectors/}
COMMENT_TIME = 'div [class="comment-date"]'
COMMENT_TEXT = 'div [class="content"]'
COMMENT_BLOCK = 'div [id="comments"]'
NEGATIVE = 'negative'
POSITIVE = 'positive'
