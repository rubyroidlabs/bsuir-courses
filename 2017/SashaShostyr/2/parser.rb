...
class Parser
  def get_links
    ...
    links = first_page.links_with(:href => /https:\/\/genius\.com\/King-of-the-dot/)
    all_pages = first_page.links_with(:href => /\/artists\/songs\?for_artist_page=117146&id=King-of-the-dot&page=\d+&pagination=true/)
    all_pages.pop
    all_pages.pop
    all_pages.pop
    all_pages.pop
    ...
    all_pages.each do |next_page|
      next_page.click.links_with(:href => /https:\/\/genius\.com\/King-of-the-dot/).each { |p| links << p }
    end
    links
  end
